...
TORNEO_CSV = os.path.join(DATA_DIR, "torneo.csv")
...
def load_torneos():
    return [Torneo(**item) for item in load_csv(TORNEO_CSV)]
...
async def create_jugador(
    ...
    activo: bool = Form(...), imagen: str = Form(...)
):
    jugadores = load_jugadores()
...
async def create_partido(
    ...
    torneo_id: int = Form(...), eliminado: str = Form(...), tarjetas_amarillas_local: int = Form(...),
...
async def create_plantilla(
    id: int = Form(...), equipo_id: int = Form(...), nombre: str = Form(...),
    posicion: str = Form(...), anio: int = Form(...), torneo_id: int = Form(...),
    jugador_id: int = Form(...)
):
    plantillas = load_plantillas()
...
@app.post("/equipos/{id}/update", response_class=HTMLResponse)
...
@app.post("/jugadores/{id}/update", response_class=HTMLResponse)
async def update_jugador(id: int, Jugadores: str = Form(...), F_Nacim_Edad: str = Form(...),
                        Club: str = Form(...), Altura: str = Form(...), Pie: str = Form(...),
                        Partidos_con_la_seleccion: int = Form(...), Goles: int = Form(...),
                        Numero_de_camisa: int = Form(...), anio: int = Form(...), posicion: str = Form(...),
                        activo: bool = Form(...), imagen: str = Form(...)):
...
@app.post("/partidos/{id}/update", response_class=HTMLResponse)
async def update_partido(id: int, equipo_local: str = Form(...), equipo_visitante: str = Form(...),
                        fecha: str = Form(...), goles_local: int = Form(...), goles_visitante: int = Form(...),
                        torneo_id: int = Form(...), eliminado: str = Form(...), tarjetas_amarillas_local: int = Form(...),
                        tarjetas_amarillas_visitante: int = Form(...), tarjetas_rojas_local: int = Form(...),
                        tarjetas_rojas_visitante: int = Form(...)):
...
@app.post("/plantillas/{id}/update", response_class=HTMLResponse)
async def update_plantilla(id: int, equipo_id: int = Form(...), nombre: str = Form(...),
                          posicion: str = Form(...), anio: int = Form(...), torneo_id: int = Form(...),
                          jugador_id: int = Form(...)):
    plantillas = load_plantillas()
    new_plantilla = Plantilla(id=id, equipo_id=equipo_id, nombre=nombre, posicion=posicion,
...
@app.post("/torneos/{id}/update", response_class=HTMLResponse)
async def update_torneo(id: int, nombre: str = Form(...), anio: int = Form(...),
                       pais_anfitrion: str = Form(...), estado: str = Form(...), eliminado: str = Form(...)):
    torneos = load_torneos()
    new_torneo = Torneo(id=id, nombre=nombre, anio=anio, pais_anfitrion=pais_anfitrion,
                        estado=estado, eliminado=eliminado)
